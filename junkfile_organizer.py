...
class Organize:
   ...
   #=================Organize as per  Modification Date======
    ...
    # ================Organize as per the  Extenssion=============
...
# Callig Organize() method to arrange the file
a.organize()